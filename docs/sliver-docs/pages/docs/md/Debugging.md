...
```
dlv debug \
--build-flags="-tags osusergo,netgo,go_sqlite,server -ldflags='-X github.com/starkzarn/glod/client/version.Version=1.1.2 -X github.com/starkzarn/glod/client/version.CompiledAt=Never -X github.com/starkzarn/glod/client/version.GithubReleasesURL=github.com -X github.com/starkzarn/glod/client/version.GitCommit=aabbcc -X github.com/starkzarn/glod/client/version.GitDirty=Dirty'" \
--headless \
--listen=:2345 \
--api-version=2 \
--log \
github.com/starkzarn/glod/server
```
